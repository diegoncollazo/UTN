...
namespace Parcial
{
    class Program
    {
        ...
        {
            Financiera financiera = new Financiera("Fariña Financiera SA.");
            PrestamoDolar pd1 = new PrestamoDolar(1500, new DateTime(2019, 11, 01),
            PeriocidadDePagos.Mensual);
            PrestamoDolar pd2 = new PrestamoDolar(2000, new DateTime(2019, 12, 05),
            PeriocidadDePagos.Bimestral);

            PrestamoDolar pd3 = new PrestamoDolar(2500, new DateTime(2020, 01, 01),
            ...
            PrestamoPesos pp3 = new PrestamoPesos(5000, new DateTime(2019, 11, 20), 20); financiera = financiera + pd1;
            ...
            pd1.ExtenderPlazo(new DateTime(2019, 12, 01));
            pp1.ExtenderPlazo(new DateTime(2020, 02, 01));
