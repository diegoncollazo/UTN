...
namespace SP
{
    ...
    public partial class Botonera: Form
    {
        ...
        {
            MessageBox.Show("Bustos Veronica");
        }
        ...
        {
            MessageBox.Show(Botonera.ObtenerListadoFrutas());
        }
        ...
        {
            if (Botonera.AgregarFrutas(this))
            {
        ...
        private static bool AgregarFrutas(Botonera frm)
        {
            throw new NotImplementedException();
        }
