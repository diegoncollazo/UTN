...
namespace SP
{
    ...
    public partial class SegundoParcial: Form
    {
        ...
        private void btnPunto4_Click(object sender, EventArgs e)
        {
            ...
            catch (CajonLlenoException error)
            {
                MessageBox.Show(error.Message, "Error al agregar frutas", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnPunto5_Click(object sender, EventArgs e)
        {
            ...
            this.c_bananas.EventoPrecio += new Cajon<Banana>.DelegadoEventoPrecio(manejador.ManejadorEventoPrecio);
        ...
        private static bool AgregarFrutas(SegundoParcial frm)
        {
            ...
            try
            {
                ...
                using (SqlConnection sqlConexion = new SqlConnection(Properties.Settings.Default.Conexion))
                {
                    ...
                    comando.CommandText = "INSERT INTO [frutas] ([nombre],[peso],[precio])" + " VALUES (@nombre, @peso, @precio)";
                    comando.Parameters.AddWithValue("@nombre", frm._durazno.Nombre);
                    comando.Parameters.AddWithValue("@peso", frm._durazno.Peso);
                    comando.Parameters.AddWithValue("@precio", frm.c_duraznos.PrecioTotal / frm.c_duraznos.Elementos.Count);
