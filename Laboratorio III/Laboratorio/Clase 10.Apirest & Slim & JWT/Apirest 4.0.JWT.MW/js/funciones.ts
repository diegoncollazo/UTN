...
$(document).ready(function(){
    ...
    $("#btn_alert_js").click(function(){

        alert("click - alert");
    });

    $("#btn_alert_on").click(function(){

        $("#alert_success").removeClass("invisible");
        $("#alert_success").addClass("visible");
        $("#alert_success").html("Mensaje desde Typescript.");
    });

    $("#btn_alert_off").click(function(){

        $("#alert_success").removeClass("visible");
        $("#alert_success").addClass("invisible");
    });	
});

const APIREST:string = "http://localhost/lab_3/clase09/BACKEND/apiRest/";
...
function ApiRestGetListadoAutos():void {
    ...
    .done(function (resultado:any) {
        //MUESTRO EL RESULTADO DE LA PETICION
        console.log(resultado);
        $("#divResultado").html(JSON.stringify(resultado));
    })
    .fail(function (jqXHR:any, textStatus:any, errorThrown:any) {
        alert(jqXHR.responseText + "\n" + textStatus + "\n" + errorThrown);
    });    
...
function ApiRestGetListadoAutosTabla():void {
    ...
    .done(function (resultado:any) {
        ...
        let tabla:string = ArmarTablaAutos(resultado);
